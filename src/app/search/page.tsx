...
const genres = [
  ...
  { name: 'Bollywood', hint: 'bollywood dance', imageUrl: 'https://images.unsplash.com/photo-1604618283387-703d294a2a4b?w=800' },
  { name: 'Punjabi', hint: 'punjabi dhol', imageUrl: 'https://images.unsplash.com/photo-1620003754292-5d15a4204561?w=800' },
