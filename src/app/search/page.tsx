...
const genres = [
  ...
  { name: 'Bollywood', hint: 'bollywood dance', imageUrl: 'https://images.unsplash.com/photo-1588623228499-535140346140?w=800' },
  { name: 'Punjabi', hint: 'punjabi dhol', imageUrl: 'https://images.unsplash.com/photo-1618397768222-b3a27e7f6e32?w=800' },
